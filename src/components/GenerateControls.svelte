<script lang="ts">
    ...
    $: withAmplitudes = attachReciprocalAmplitudes({ rates: stretchedRates, slope, amplitude })
...
<Controls title="Seed:">
    ...
    <Range label="Amplitude" min={0} max={2} step={0.005} onInput={(value) => (amplitude = value)} initialValue={amplitude} />
</Controls>
