...
New Tonality project is aimed to popularize and advance ideas laid out by Sethares in his book. Some theory is covered on my [YouTube channel](https://www.youtube.com/@new_tonality) and for practical stuff, check out [xen-tonal additive synthesizer](/tools/synth) and [tool to research dissonance](/tools/dissoannce-lab) to start experimenting with xen-tonality. It is in the early stage of active development, you can follow updates on [Ko-Fi](https://ko-fi.com/newtonality). Also feel free to contribute to the development on [Github](https://github.com/new-tonality-project). 

## Support

Support my work by spreading knowledge, using New Tonality tools in your music. Consider donating on [Ko-Fi](https://ko-fi.com/newtonality) buying my [eBook](https://payhip.com/b/TtdJB). Also check out my music that I do as an Offcast on [Bandcamp](https://offcast.bandcamp.com/album/redemption).
